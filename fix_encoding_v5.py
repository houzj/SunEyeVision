...
# -*- coding: utf-8 -*-
"""
SunEyeVision 编码问题修复脚本 v5
修复UTF-8中文被截断的问题（末尾字节被替换为0x3F）
"""
...
def main():
    print("=" * 70)
    print("SunEyeVision 编码问题修复脚本 v5")
    print("修复UTF-8中文被截断的问题")
    print("=" * 70)
    ...
    print(f"\n问题文件列表 (前40个):")
    print("-" * 70)
    for _, rel, count, _ in results[:40]:
        print(f"  {rel} ({count}处)")
    if len(results) > 40:
        print(f"  ... 还有 {len(results) - 40} 个文件")
