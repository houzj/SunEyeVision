...
namespace SunEyeVision.UI.ViewModels
{
    ...
    public class WorkflowViewModel : ViewModelBase
    {
        ...
        private void InitializeSampleWorkflow()
        {
            ...
            Connections.Add(new WorkflowConnection("conn1", "node1", "node2"));
            Connections.Add(new WorkflowConnection("conn2", "node2", "node3"));
            Connections.Add(new WorkflowConnection("conn3", "node3", "node4"));
        }
