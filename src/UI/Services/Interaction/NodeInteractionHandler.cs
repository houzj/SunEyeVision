    ...
    public class WorkflowNodeInteractionHandler
    {
        ...
        public void SetPortsVisibility(Border border, bool isVisible)
        {
            ...
            foreach (var ellipse in ellipses)
            {
                ...
                {
                    ellipse.Visibility = isVisible ? Visibility.Visible : Visibility.Hidden;
                }
            }
        }
