...
for filepath in files_to_fix:
    ...
    # 移除<Window.CustomContent>和</Window.CustomContent>标签
    original_content = content
    content = re.sub(r'<Window\.CustomContent>\s*', '', content, flags=re.DOTALL)
    content = re.sub(r'\s*</Window\.CustomContent>\s*', '', content, flags=re.DOTALL)
