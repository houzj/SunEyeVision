...
namespace SunEyeVision.Services
{
    /// <summary>
    /// 文件日志记录器实现
    /// </summary>
    public class FileLogger : SunEyeVision.Interfaces.ILogger
    {
        ...
        private void InitializeLogFile()
        {
            ...
            _logFilePath = Path.Combine(_logDirectory, $"SunEyeVision_{dateStr}.log");
        }
